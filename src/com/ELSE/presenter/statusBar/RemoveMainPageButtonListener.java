...
public class RemoveMainPageButtonListener implements ActionListener {
	...
	public RemoveMainPageButtonListener(View view, Pathbase pathbase,
	...
	public void actionPerformed(ActionEvent e) {
		String input = (String) JOptionPane.showInputDialog(null,
				"Scegli il percorso da cancellare: ", "Rimuovi percorso",
				JOptionPane.QUESTION_MESSAGE, null, pathbase.getPathsList()
						.toArray(), pathbase.getPathsList().get(0));
		if (input != null)
